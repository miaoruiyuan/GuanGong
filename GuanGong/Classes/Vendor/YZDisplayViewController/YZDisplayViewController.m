...
- (UIScrollView *)titleScrollView
{
    if (_titleScrollView == nil) {
        ...
        titleScrollView.frame = CGRectMake(0, 0, YZScreenW, 30);
        ...
        //Begin Add By CodingTom 2017-06-07 11:00:12
        CALayer *bottomLayer = [CALayer layer];
        float width1 = titleScrollView.frame.size.width;
        bottomLayer.frame = CGRectMake(0.0f, 43.5f, width1, 0.5f);
        bottomLayer.backgroundColor = sectionColor.CGColor;
        [titleScrollView.layer addSublayer:bottomLayer];
        //End Add By CodingTom 2017-06-07 11:00:12
...
- (void)viewDidLayoutSubviews
{
    ...
    if (_isInitial == NO) {
        ...
        CGFloat titleY = self.navigationController.navigationBarHidden == NO ?statusH + NavH:statusH;

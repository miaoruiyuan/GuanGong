...
- (void)drawRect:(CGRect)rect {
	...
	for(NSString *titleString in self.sectionTitles) {
       ...
       // [titleString drawAtPoint:CGPointMake(titlePosX+imageWidth, posY) forWidth:self.segmentWidth withFont:self.font lineBreakMode:NSLineBreakByClipping];
        ...
        [titleString drawInRect:CGRectMake(titlePosX+imageWidth, posY, self.segmentWidth, CGFLOAT_MAX) withAttributes:@{NSFontAttributeName : self.font ,NSParagraphStyleAttributeName : paragraphStyle}];
		i++;
	}
}

...
/** @name Sections Headers & Footers */
#pragma mark Sections Headers & Footers
- (CGFloat)multiTablesView:(MultiTablesView *)multiTablesView level:(NSInteger)level heightForRowAtIndexPath:(NSIndexPath *)indexPath;
...
- (NSInteger )multiTablesView:(MultiTablesView *)multiTablesView level:(NSInteger)level sectionForSectionIndexTitle:(NSString *)title atIndex:(NSInteger)index;

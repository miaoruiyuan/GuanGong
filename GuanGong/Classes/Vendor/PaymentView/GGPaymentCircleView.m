...
@implementation GGPaymentCircleView
...
- (void)loadStatus:(GGLoadStatus )status{
    ...
    switch (status) {
        case GGLoadStatusLoading: {
            ...
            break;
        case GGLoadStatusSuccess: {
            
            UIBezierPath *path = [UIBezierPath bezierPath];
            [path moveToPoint:CGPointMake(14, 46)];
            [path addLineToPoint:CGPointMake(35, 58)];
